<template>
  <div class="question">
            ...
            <div class="Question">
              <div class="title">
                <h1>Q3</h1>
                <h3>สไตล์การเรียนภาษาอังกฤษของคุณเป็นแบบไหน ?</h3>
              </div>
              <!-- <div>Checked names: {{ checkedNames }}</div> -->
              <div class="content">
                <button type="submit" class="button_Q" @click="handleButtonClick(30)">เรียนคอร์สออนไลน์/โรงเรียนสอนภาษา</button>
                <button type="submit" class="button_Q" @click="handleButtonClick(20)">เรียนด้วยตนเอง เช่น ดูหนัง อ่านหนังสือ ฟังเพลง</button>
                <button type="submit" class="button_Q" @click="handleButtonClick(10)">คุยกับเพื่อนต่างชาติ / ไปเที่ยวต่างประเทศ</button>
              </div>
            </div>
